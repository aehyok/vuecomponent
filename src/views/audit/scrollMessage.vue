...
import ScrollMessageDetail from './ScrollMessageDetail'

import {
  auditGetScrollMessageList,
...
export default {
  ...
  computed: {
    tableCols() {
      ...
      return [
        ...
        console.log(this.filters.auditStatus)
  ...
  methods: {
    ...
    async getList() {
      ...
      const res = await auditGetScrollMessageList({
        page: this.page,
        limit: this.limit,
        ...this.filters,
      })
